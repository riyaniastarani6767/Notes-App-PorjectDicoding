      ...
      <div class="auth-shell">
        <section class="auth-card" role="region" aria-labelledby="login-title">
          ...
          <form id="loginForm" novalidate>
            ...
            <input id="password" class="input" type="password" name="password" required aria-required="true" minlength="8" placeholder="Enter password"/>
...
// import { saveAuth } from "../scripts/utils/store.js";
...
//         saveAuth({ token, name });
//         window.location.hash = "#/"; // ke beranda
//       } catch (err) {
//         msg.textContent =
//           err?.message || "Gagal masuk. Periksa email & password.";
//       } finally {
