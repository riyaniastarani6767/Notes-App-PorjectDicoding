...
//         <section class="auth-card" role="region" aria-labelledby="reg-title">
//           <h2 id="reg-title" class="auth-title">Create Account</h2>
//           <p class="auth-subtitle">Join and share your stories</p>

//           <form id="regForm" novalidate>
//             <label for="name">Nama</label>
//             <input id="name" class="input" name="name" required placeholder="Nama lengkap"/>

//             <label for="email">Email</label>
//             <input id="email" class="input" type="email" name="email" required placeholder="email@example.com"/>

//             <label for="password">Password (≥ 8)</label>
//             <input id="password" class="input" type="password" name="password" required minlength="8" placeholder="Minimal 8 karakter"/>

//             <div style="margin-top:14px">
//               <button id="btnReg" class="btn-primary" type="submit">Sign up</button>
//             </div>

//             <p id="regMsg" role="alert" style="margin-top:10px"></p>
//             <p class="auth-bottom">Sudah punya akun? <a href="#/login">Sign in</a></p>
//           </form>
//         </section>
//       </div>
//     `;
...
//         msg.style.color = "#16a34a";
//         msg.textContent = res?.message || "Register sukses. Silakan login.";
//         setTimeout(() => (window.location.hash = "#/login"), 800);
//       } catch (err) {
//         msg.style.color = "#dc2626";
//         msg.textContent = err?.message || "Register gagal.";
//       } finally {
//         btn.disabled = false;
